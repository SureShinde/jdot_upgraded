<?php
namespace RLTSquare\ConfirmOrder\Controller\Adminhtml\Mail;
    ...
    public function execute()
    {
        try {
            ...
            foreach ($collection->getItems() as $order) {
                ...
                $orderConfirmationLink = $this->urlBuilder->getUrl('confirmorder/order/confirm', [ '_scope' => 1, 'order_id' => $encryptedOrderId, '_nosid' => true ]);
                ...
                $this->sendEmail(73,1,$parseDataVars,$email);

                $order->addStatusHistoryComment("Confirm Email sent to customer"." (".$username.")");
                $order->save();
            }
