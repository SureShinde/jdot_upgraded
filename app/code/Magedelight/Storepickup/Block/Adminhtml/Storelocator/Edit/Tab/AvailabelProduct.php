...
class AvailabelProduct extends \Magento\Backend\Block\Widget\Form\Generic implements
    \Magento\Ui\Component\Layout\Tabs\TabInterface
{
    ...
    {
        $model = $this->_coreRegistry->registry('magedelight_storelocator_storelocator');
    ...
    protected function addTabToForm($model, $fieldsetId = 'conditions_fieldset', $formName = 'arp_form')
    {
        ...
        $fieldset = $form->addFieldset(
            $fieldsetId,
            [
                'legend' => '<div class="message message-notice notice">Choose products that availabel in this store. Conditions and condition combinations allow you to narrow selection down to a specific range of products</div>'
            ]
        )->setRenderer(
            $renderer
        );
        ...
        $renderer = $this->getLayout()->createBlock('Magedelight\Storepickup\Block\Adminhtml\Storelocator\Form\Renderer\ConditionButton');
    ...
    {
        return $formName . 'rule_conditions_fieldset_' . $this->getStorelocatorId();
    }
}
