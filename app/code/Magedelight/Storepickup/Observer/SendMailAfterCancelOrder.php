...
class SendMailAfterCancelOrder implements ObserverInterface
{
    ...
    public function execute(\Magento\Framework\Event\Observer $observer)
    {
        try
        {
            ...
            $order = $this->orderRepository->get($orderId->getIncrementId());
            if($order->getShippingMethod() == 'storepickup_storepickup')
            {
                ...
                $storeEmail = $storelocatorData[0]['storeemail'];
                    ...
                    $transport = $this->transportBuilder->setTemplateIdentifier('sales_order_cancel_template')
