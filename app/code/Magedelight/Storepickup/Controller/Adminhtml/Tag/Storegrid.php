...
class Storegrid extends \Magedelight\Storepickup\Controller\Adminhtml\Storelocator
{
...
/*public function __construct(
    ...
    public function execute()
    {
        ...
        try {
            ...
            $tagStores = $request->getPost('store_ids', null);
            
            /*$this->productBuilder->build($request);*/
            
            $resultLayout->getLayout()->getBlock('magedelight.storepickup.edit.tab.storegrid')
                ->setStores($tagStores);
            return $resultLayout;
        } catch (\Exception $ex) {
