...
class Storeholiday extends AbstractDb
{
    ...
    {
        $this->_init('magedelight_store_holiday', 'holiday_id');
    }
    ...
    {
        $condition = ['holiday_id = ?' => (int) $object->getId()];
        $this->getConnection()->delete($this->getTable('magedelight_store_holiday'), $condition);
