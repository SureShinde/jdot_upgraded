 ...
 */
namespace Aalogics\Lcs\Block\System\Config;
...
class Sync extends \Magento\Config\Block\System\Config\Form\Field
{
     ...
     * @var string
     */
    protected $_template = 'Aalogics_Lcs::system/config/sync.phtml';
    ...
    {
        return $this->getUrl('aalcs/system_config/sync');
    }
