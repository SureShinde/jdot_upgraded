...
class MassShipInvoice extends \Magento\Sales\Controller\Adminhtml\Order\AbstractMassAction
{
    /**
     * Authorization level of a basic admin session
     */
    const ADMIN_RESOURCE = 'Aalogics_Lcs::massshipinvoice';
    ...
    //     		$countCancelOrder++;
            ...
            if($this->_lcsHelper->isShippingEnabled()){
                ...
                $this->messageManager->addError('LCS Invoice and shippement Not Enabled');
            }
