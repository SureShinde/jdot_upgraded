...
{
	const XML_MSG91_API_SENDERID = 'sms/smsgatways/msg91senderid';
    const XML_MSG91_API_AUTHKEY = 'sms/smsgatways/msg91authkey';
	const XML_MSG91_API_URL = 'sms/smsgatways/msg91apiurl';
