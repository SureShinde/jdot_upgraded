require(
    ...
    function ($) {
        $(document).ready(function () {
            $('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline legend.admin__legend.legend').append(' <span class="package-down-arrow">&#9660;</span><span class="package-up-arrow">&#9650;</span><span class="package-delete">&#10006;</span>');
            $('#infomodus_dhllabel_items_edit_tabs_package_section').append('<button type="button" class="scalable primary add-package">Add new package</button>');
            var package0 = $('#item_package_fieldset_0_').clone(true);
            $('#infomodus_dhllabel_items_edit_tabs_package_section').on('click', 'button.add-package', function () {
                var countFieldSet = $('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline fieldset').length, i = 0;
                for (i = 0; i < 200; i++) {
                ...
                $('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline legend.admin__legend.legend .package-up-arrow').trigger('click');
                packageCurrent.appendTo($('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline'));
            });

            $('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline').on('click', '.package-up-arrow', function () {
            ...
            $('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline').on('click', '.package-down-arrow', function () {
            ...
            $('#infomodus_dhllabel_items_edit_tabs_package_section_content .entry-edit.form-inline').on('click', '.package-delete', function () {
            ...
            $('#edit_form').on('change', '.box-selected', function(){
                if($(this).val().length > 1) {
                    ...
                    $(this).closest('fieldset').find('.box-packweight').val(dimensions[3]);
                } else {
                    ...
                    $(this).closest('fieldset').find('.box-packweight').val('');
                }
            });
        });
