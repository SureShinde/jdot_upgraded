 ...
 */
namespace Infomodus\Dhllabel\Block\Adminhtml\Items;
...
class Edit extends \Magento\Backend\Block\Widget\Form\Container
{
    ...
    protected function _construct()
    {
        ...
        $this->_blockGroup = 'Infomodus_Dhllabel';
        ...
        $this->addButton(
            ...
            [
                ...
                'class' => __('primary'),
                'id' => 'get-price-button',
                'onclick' => 'window.getLabelPrice(\''.$this->getUrl('infomodus_dhllabel/items/price', ['order_id' => $this->getRequest()->getParam('order_id'), 'type' => $this->getRequest()->getParam('direction')]).'\')'
            ]
        );
    }
