...
return [
    'modules' => [
        ...
        'Arpatech_CityDropdown' => 1,
        'Arpatech_CustomConfigurableProduct' => 1,
        'Arpatech_CustomInvoiceNumber' => 1,
        'Arpatech_CustomPrint' => 1,
        'Arpatech_Customshipping' => 1,
        'Arpatech_GridColumn' => 1,
        'Arpatech_OrderItemImage' => 1,
        'Arpatech_TempFixConfigurableProduct' => 1,
        'Arpatech_Ubl' => 1,
        'CustomerParadigm_OrderComments' => 1,
        ...
        'OxCom_MagentoCurrencyServices' => 1,
        'PayPal_Braintree' => 1,
        'PayPal_BraintreeGraphQl' => 1,
        'Pentalogy_Callcourier' => 1,
        'Plumrocket_Base' => 1,
        'Plumrocket_SizeChart' => 1,
        'RLTSquare_CallCourierInvoiceIssue' => 1,
        'RLTSquare_CustomPrint' => 1,
        'RLTSquare_EmailContent' => 1,
        'RLTSquare_OrderTrackingStatus' => 1,
        'RLTSquare_TcsShipping' => 1,
        'Remmote_Facebookpixelremarketing' => 1,
